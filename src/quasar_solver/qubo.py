...
class QUBO:
    ...
    ----------
    Q : np.ndarray
        The square, symmetric QUBO matrix.
    ...
    def __init__(self, Q: np.ndarray):
        ...
        ----------
        Q : np.ndarray
            A 2D NumPy array representing the QUBO matrix.
            It must be a square matrix.

        Raises
        ------
        ValueError
            If Q is not a square 2D NumPy array.
        """
    ...
    def energy(self, x: np.ndarray) -> float:
        ...
        ----------
        x : np.ndarray
            A 1D NumPy array of binary variables {0, 1}.

        Returns
        -------
        float
            The calculated energy for the given state.

        Raises
        ------
        ValueError
            If x is not a 1D array of the correct length.
        """
    ...
    """Calculates the change in energy from flipping a single bit using Numba njit.
        ...
        ----------
        x : np.ndarray
            The current 1D binary state vector.
        ...
        -------
        float
            The change in energy (ΔE) that would result from the flip.
        """
